...
# Form implementation generated from reading ui file 'guifinal2.ui'
#
...
def stop():
    ...
    exit_time = datetime.datetime.now()+ datetime.timedelta(hours=x,minutes=y,seconds=z)
    #print (exit_time)
    import os
    print (time.time())
    while True:
     if exit_time <=  datetime.datetime.now():
